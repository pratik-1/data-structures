...
input and returns the longest string in the list. The function should iterate through each
string in the list, check its length, and keep track of the longest string seen so far.
...
def find_longest_string(string_list) -> int:
    longest_string = ''
